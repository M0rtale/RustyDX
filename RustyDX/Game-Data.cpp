...
int get_Active_List()
{
	...
	while (firstObject != activeObjectsPtr)
	{
		if (Game_Data::_Player_Vector.size() > 0) // if the player list is initialized(ingame)
		{
			...
			Memory::_This->Read_Memory(objectNamePtr, world_name_char, 50);
